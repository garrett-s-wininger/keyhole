...
auto
build_bytecode(const InstructionSequence& instructions)
        -> std::vector<std::byte> {
...
auto
generate_code(const InstructionSequence& instructions) -> std::vector<std::byte> {
    auto bytecode = build_bytecode(instructions);

    const attribute::CodeAttribute code{
...
generate_code(
        ...
        const InstructionSequence& instructions) -> std::vector<std::byte> {
    auto bytecode = build_bytecode(instructions);

    auto code = attribute::CodeAttribute{
