...
static constexpr auto ImplementationDependent1 = NoOperandInstruction{
    Opcode::ImplementationDependent1
};

static constexpr auto ImplementationDependent2 = NoOperandInstruction{
    Opcode::ImplementationDependent2
};
...
auto
generate_code(const InstructionSequence&) -> std::vector<std::byte>;

auto
generate_code(std::uint16_t, std::uint16_t, const InstructionSequence&)
        -> std::vector<std::byte>;
